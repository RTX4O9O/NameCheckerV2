...
set CLASSPATH=%APP_HOME%\lib\Code-1.0.jar


@rem Execute Code
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CODE_OPTS%  -classpath "%CLASSPATH%" package.to.Main %*
...
if not ""=="%CODE_EXIT_CONSOLE%" exit %EXIT_CODE%
exit /b %EXIT_CODE%
